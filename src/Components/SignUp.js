    ...
    return (
        <div className="text-center">
           ...
           <fieldset className='flex flex-col'>
            <input onChange={this.handleChange} className="px-4 py-2 my-4 border" type="text" id="username" name="username" placeholder="Username" value={this.state.username}/>
            <span className="text-red-500">{username}</span>

            <input onChange={this.handleChange} className="px-4 py-2 my-4 border" type="email" id="email" placeholder="Email" name="email" value={this.state.email} />
