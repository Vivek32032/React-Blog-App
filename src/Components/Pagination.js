            ...
            <span
              ...
              className={
                activePageIndex === page
                  ? 'bg-green-600 text-white py-2 px-4 mx-4 cursor-pointer hover:bg-green-500 my-2'
                  : 'border border-gray-400 bg-green-50 py-2 px-4 mx-4 cursor-pointer hover:bg-blue-400 my-2'
              }
